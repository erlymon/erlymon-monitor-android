...
public interface CacheDevicesView extends MvpView {
    void startCacheDevices();

    void finishCacheDevices();

    void failedCacheDevices(String message);
...
*/
    ...
    void successCacheDevices(Cursor cursor);
}
