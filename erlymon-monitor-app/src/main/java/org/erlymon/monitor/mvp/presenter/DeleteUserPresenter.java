...
@InjectViewState
public class DeleteUserPresenter extends BasePresenter<DeleteUserView> {
    ...
    public void delete(long id) {
        getViewState().startDeleteUser();

        // save session id
        Subscription subscription = mMainService.deleteUser(id)
                .subscribe(result -> {
                    getViewState().finishDeleteUser();
                    getViewState().successDeleteUser();
                }, exception -> {
                    getViewState().finishDeleteUser();
                    getViewState().failedDeleteUser(exception.getMessage());
                });
