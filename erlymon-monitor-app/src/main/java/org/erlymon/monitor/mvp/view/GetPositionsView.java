...
public interface GetPositionsView extends MvpView {
    void startGetPositions();

    void finishGetPositions();

    void failedGetPositions(String message);
...
*/
    ...
    void successGetPositions(List<Position> positions);
}
