...
@InjectViewState
public class CacheServerPresenter extends BasePresenter<GetServerView> {

    @Inject
    MainService mMainService;

    public CacheServerPresenter() {
    ...
    public void load() {
        ...
        // save session id
        Subscription subscription = mMainService.getServerByCache()
                .subscribe(server -> {
